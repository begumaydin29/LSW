...
export class AirplaneByIdDto extends BaseDto {
...
@Injectable()
export class AirplaneByIdDtoSerializer extends BaseSerializer implements Serializer {
    constructor() {
        super();
    }

    fromJson(json: any): AirplaneByIdDto {
        json = typeof json === 'object' ? json : {};
        const search = new AirplaneByIdDto();
    ...
    toJson(resource: AirplaneByIdDto) {
        const data = {};
